...
import { getActivePlan, updateActivePlan, shouldAutoBackup, markBackupDone, getGarminData, getActiveRaceDate, buildRaceContextText, buildHRZoneText, getProfile, getRunZones, getCyclingZones } from '@/lib/storage';
import { TrainingWeek, TrainingDay, GarminHealthStats } from '@/lib/types';
            ...
            {[
              ...
              <div key={label}>
                ...
                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                  {zones.map((zone, idx) => (
                    <div key={zone.zone} className={`flex items-center justify-between p-3 ${idx < zones.length - 1 ? 'border-b border-gray-100' : ''}`}>
