  ...
  if (!weather) {
    return (
      <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
        <p className="text-sm text-gray-400">Geen weergegevens beschikbaar voor deze datum.</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-xl p-4 border border-gray-200">
      <div className="flex items-center gap-4">
        ...
        <div className="text-right">
          <p className="text-2xl font-bold text-gray-900">{weather.tempMaxC}°</p>
          <p className="text-xs text-gray-400">{weather.tempMinC}° min</p>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-3 mt-4 pt-3 border-t border-gray-100 text-center">
        <div>
          <p className="text-lg font-bold text-sky-600">{weather.windMaxKmh}</p>
          <p className="text-xs text-gray-500">km/h wind</p>
        </div>
        <div>
          <p className="text-lg font-bold text-blue-500">{weather.precipitationMm}</p>
