        ...
        sessions: [
          {
            ...
            durationMinutes: 60,
            zone: 'Z2',
            description: 'Duurloop in Z2, stabiel tempo',
          },
        ],
      },
      {
        ...
        sessions: [
          {
            ...
            durationMinutes: 105,
            zone: 'Z2',
            description: 'Lange fietsrit 90-120 min in Z2',
          },
          {
            sport: 'hardlopen',
            type: 'brick',
            durationMinutes: 25,
            zone: 'Z2',
            description: 'Brick run: direct na fietsen, 20-30 min in Z2',
          },
        ],
      },
    ],
        ...
        sessions: [
          {
            ...
            durationMinutes: 50,
            zone: 'Z3',
            description: 'Temporun: 20 min opwarmen, 20 min Z3, 10 min cooldown',
          },
        ],
      },
      {
        ...
        sessions: [
          {
            ...
            durationMinutes: 65,
            zone: 'Z2',
            description: 'Duurloop in Z2, langer dan week 1',
          },
        ],
      },
      {
